							...
							<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="<?php echo base_url()?>assets/img/single_property/1.png" alt="">
									</div>
									<div class="item">
										<img src="<?php echo base_url()?>assets/img/single_property/2.png" alt="">
									</div>
									<div class="item">
										<img src="<?php echo base_url()?>assets/img/single_property/3.png" alt="">
									</div>
								</div>
								...
								<div class="people-rating ">
									...
									<ul class="user-comments">
										<li>
											<div class="comment_description">
												<div class="author_img">
													<img src="<?php echo base_url()?>assets/img/blog_detail/comment-1.png" alt="">
												</div>
										...
										<li>
											<div class="comment_description">
												<div class="author_img">
													<img src="<?php echo base_url()?>assets/img/blog_detail/comment-2.png" alt="">
												</div>
												<div class="author_text">
													<div class="author_info">
										...
										<li>
											<div class="comment_description">
												<div class="author_img">
													<img src="<?php echo base_url()?>assets/img/blog_detail/comment-4.png" alt="">
												</div>
												<div class="author_text">
													<div class="author_info">
						...
						<div class="property_sidebar">
							...
							<div class="contact_agent sidebar-widget">
								<div class="agent_details">
									<div class="author_img">
										<img src="<?php echo base_url()?>assets/img/testimonial/2.png" alt="">
									</div>
							...
							<div class="property_slide">
								<div class="item">
									<div class="property_grid">
										<div class="<?php echo base_url()?>assets/img_area">
